...
import com.example.vocabularyengapplication.databinding.ItemCategoryBinding
          ...
          itemCategoryBinding.tvCategory.text = item.title
            if(item.ordinal == selectedCategory.ordinal){
                itemCategoryBinding.border.setCardBackgroundColor(
                    itemCategoryBinding.root.context.getColor(R.color.colorBackgroundStartButton)
                )
            } else{
                itemCategoryBinding.border.setCardBackgroundColor(
                    itemCategoryBinding.root.context.getColor(R.color.colorCardBackground)
                )
            }
